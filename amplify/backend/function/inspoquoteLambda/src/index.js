...
// Function: update DynamoDB table
 async function updateQuoteDDBObject() {
    const quoteTableName = "QuoteAppData-vgzanbxohnghpdyfwnl33lwboe-dev";
    const quoteObjectID = "123-1234-12345";
    try {
        var quoteParams = {
    ...
    async function getRandomQuotes(apiURLInput) {
        ...
        const svgImage = `
              <svg width="${width}" height="${height}">
                    ...
                    <text x="${width / 2}" y="${height - 10}" class="footerStyles">Developed by @MohamedNabil | Quotes from ZenQuotes.io</text>
                </svg>        
              `;
